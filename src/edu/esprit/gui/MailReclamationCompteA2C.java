 ...
 * @author luca
 */
public class MailReclamationCompteA2C extends javax.swing.JFrame {

    /**
     * Creates new form MailReclamationOffre
     */
    public MailReclamationCompteA2C(String email) {
        initComponents();
        ReceiverAdress.setText(email);
        senderpwd.setToolTipText("oldpwd : luca1992");
    ...
    private void initComponents() {
        ...
        ReceiverAdress = new javax.swing.JTextField();
        ...
        senderAdress.setEditable(false);
        senderAdress.setText("esprit.3a15.realestateagency@gmail.com");

        ReceiverAdress.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ReceiverAdressFocusLost(evt);
            }
        });
                        ...
                        .addGroup(jTextArearObjectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jTextArearObjectLayout.createSequentialGroup()
                                .addGroup(jTextArearObjectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(senderAdress, javax.swing.GroupLayout.PREFERRED_SIZE, 357, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jTextArearObjectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jTextArearObjectLayout.createSequentialGroup()
                                        .addGap(1, 1, 1)
                ...
                .addGroup(jTextArearObjectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jTextArearObjectLayout.createSequentialGroup()
                        ...
                        .addGroup(jTextArearObjectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(ReceiverAdress, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jTextArearObjectLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        ...
        String to = ReceiverAdress.getText();
        String subject = subjectText.getText();
        if (Checker.checkEmail(to) && !pass.isEmpty() && !corps.isEmpty() && !subject.isEmpty()) {
    ...
    private void ReceiverAdressFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ReceiverAdressFocusLost
 if (Checker.checkEmail(ReceiverAdress.getText())) {
            ReceiverAdress.setForeground(Color.green);
        } else {
            ReceiverAdress.setForeground(Color.red);
        }
        // TODO add your handling code here:
    }//GEN-LAST:event_ReceiverAdressFocusLost
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MailReclamationCompteA2C.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    new MailReclamationCompteA2C("malik.benabda@gmail.com").setVisible(true);
                } catch (UnsupportedLookAndFeelException ex) {
                    Logger.getLogger(MailReclamationCompteA2C.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    private javax.swing.JTextField ReceiverAdress;
