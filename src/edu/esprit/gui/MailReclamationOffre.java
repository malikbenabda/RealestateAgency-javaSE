 ...
 * @author luca
 */
public class MailReclamationOffre extends javax.swing.JFrame {

    /**
     * Creates new form MailReclamationOffre
     */
    public MailReclamationOffre(String email, int offreid) {
        initComponents();
        senderAdress.setText(email);
        subjectText.setText(subjectText.getText() + " " + offreid);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reclamation sur offre");
        ...
        subjectText.setText("Reclamation sur Offre - Id : ");
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        ...
        if (Checker.checkEmail(from) && !pass.isEmpty() && !corps.isEmpty()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MailReclamationOffre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MailReclamationOffre("malik.benabda@gmail.com", 22).setVisible(true);
            }
        });
    }
